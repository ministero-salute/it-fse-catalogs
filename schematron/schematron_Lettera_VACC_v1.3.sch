...
<!--_______________________________________________________________HEADER _____________________________________________________________-->
		...
		<rule context="hl7:ClinicalDocument">
			...
			<!--Controllo code-->	
			<assert test="count(hl7:code[@code='111490-9'][@codeSystem='2.16.840.1.113883.6.1']) = 1"
			>ERRORE-4a| L'elemento <name/>/code DEVE essere valorizzato con l'attributo @code='111490-9' e il @codeSystem='2.16.840.1.113883.6.1'</assert>
			...
			>ERRORE-10| Nel caso di Soggetti assicurati da istituzioni estere, devono essere riportati almeno due elementi di tipo 'id' contenenti:
			...
			>ERRORE-10a| Nel caso di Stranieri Temporaneamente Presenti, l'elemento <name/>/recordTarget/patientRole/id  deve avere l'attributo @root valorizzato tramite un identificativo STP.</assert>
			...
			>ERRORE-11a| L'elemento <name/>/recordTaget/patientRole DEVE contenere l'elemento patient</assert>
			...
			<assert test="count(hl7:documentationOf)=0 or count(hl7:documentationOf/hl7:serviceEvent/hl7:code[@code='111490-9' and @codeSystem='2.16.840.1.113883.6.1'])=1 or count(hl7:documentationOf/hl7:serviceEvent/hl7:code[@code='112074-0' and @codeSystem='2.16.840.1.113883.6.1'])=1"
			>ERRORE-26| L'elemento ClinicalDocument/documentationOf/serviceEvent/code deve essere presente e il suo elemendo code deve avere l'attributo @codeSystem valorizzato con '2.16.840.1.113883.6.1' e l'attributo @code valorizzato con uno dei seguenti valori:
			- 111490-9, con @displayName “Immunization invitation letter”;
			- 112074-0, con @displayName “Immunization reminder letter”. </assert>
...
<!--__________________________________________________BODY__________________________________________________________________________-->
		...
		<!--Lett VACCINAZIONE-->
			...
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944'])=1">
			ERRORE-b1| Sezione Lettera Vaccinazione: la sezione DEVE essere presente con templateId/@root valorizzato con il seguente OID '2.16.840.1.113883.3.1937.777.63.10.944'.</assert>
			
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944'])=0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:code[@code='112069-0' and @codeSystem='2.16.840.1.113883.6.1'])=1"
			>ERRORE-b2| Sezione Lettera Vaccinazione: la sezione DEVE contenere un elemento code. Tale elemento deve essere valorizzato con l'attributo @codeSystem pari al seguente OID '2.16.840.1.113883.6.1' e con l'attributo @code pari a '112069-0'(Immunization invitation letter). </assert>
			
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944'])=0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:text)=1"
			>ERRORE-b3| Sezione Lettera Vaccinazione: la sezione DEVE contenere un elemento text. </assert>

			<assert test="
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:encounter)=0
			  or
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:encounter[@moodCode='APT' or @moodCode='RQO'])=1">
			...
			<assert test="
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:encounter)=0
			  or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:encounter/hl7:effectiveTime[@value or @nullFlavor='UNK'])=1">
			...
			<assert test="
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:encounter/hl7:entryRelationship)=0
			  or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:encounter/hl7:entryRelationship/hl7:observation/hl7:code[@code='ASSERTION'][@codeSystem='2.16.840.1.113883.5.4'])=1">
			  ERRORE-b5| Sezione Lettera Vaccinazione: l'elemento encounter deve contentenere all'interno l'elemento code con gli attributi valorizzati nel seguente modo: 
			  @code valorizzato con 'ASSERTION'
			  @codeSystems valorizzato con il seguente OID "2.16.840.1.113883.5.4"
			</assert>
	
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944'])=0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.945']])>=1"  
			>ERRORE-b5a| Sezione Lettera Vaccinazione: la sezione DEVE contenere almeno un elemento di tipo 'entry' con templateId/@root valorizzato con il seguente OID '2.16.840.1.113883.3.1937.777.63.10.945'.</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.945']]">
			<assert test="count(hl7:code[@code='112072-4' and @codeSystem='2.16.840.1.113883.6.1'])=1"
			>ERRORE-b9| Sezione Lettera Vaccinazione: All'interno della entry/act (Malattia) DEVE essere presente un elemento code, valorizzato con l'attributo @codeSystem pari al seguente OID '2.16.840.1.113883.6.1' e con l'attributo @code pari a '112072-4'(Immunization letter). </assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.944']]/hl7:entry/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.945']]/hl7:entryRelationship">
			<assert test="@typeCode='RSON'"
			>ERRORE-b12| Sezione Lettera Vaccinazione: All'interno dell'elemento entry/act/templateId[@root='2.16.840.1.113883.3.1937.777.63.10.945']/<name/> l'attributo @typeCode DEVE essere valorizzato con il valore "RSON"</assert>
			
			<assert test="@inversionInd='false'"
			>ERRORE-b13|Sezione Lettera Vaccinazione: All'interno dell'elemento entry/act/templateId[@root='2.16.840.1.113883.3.1937.777.63.10.945']/<name/> l'attributo @inversionInd DEVE essere valorizzato con il valore "false"</assert>
			
			<assert test="count(hl7:observation[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.675']])=1"
			>ERRORE-b14|Sezione Lettera Vaccinazione: All'interno dell'elemento entry/act/templateId[@root='2.16.840.1.113883.3.1937.777.63.10.945']/<name/> DEVE essere presente una observation con templateId con @root valorizzato con il seguente OID "2.16.840.1.113883.3.1937.777.63.10.675"</assert>		
