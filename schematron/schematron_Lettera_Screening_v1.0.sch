...
<!--_______________________________________________________________HEADER _____________________________________________________________-->
		...
		<rule context="hl7:ClinicalDocument">
			...
			<assert test = "count(hl7:documentationOf/hl7:serviceEvent/hl7:code[@codeSystem='2.16.840.1.113883.6.1'])=2"
			>ERRORE-26| L'elemento ClinicalDocument/documentationOf/serviceEvent DEVE contenere l'elemento code valorizzato con l'attributo @codeSystem che riporti il seguente OID '2.16.840.1.113883.6.1'</assert>
...
<!--__________________________________________________BODY__________________________________________________________________________-->
		...
		<!--Controlli sulle sezioni obbligatorie-->
			...
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.613'])=0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.613']]/hl7:code[@codeSystem='2.16.840.1.113883.6.1'])=1"
			>ERRORE-b2| Sezione Lettera Screening: la sezione DEVE contenere un elemento code con l'attributo @codeSystems valorizzato con il seguente OID "2.16.840.1.113883.6.1"</assert>
			...
			<assert test="count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.613']]/hl7:entry) = 0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.613']]/hl7:entry/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.614']]/hl7:entryRelationship/hl7:procedure/hl7:code[@codeSystem='2.16.840.1.113883.6.1'])=1" 
			>ERRORE-b10| Sezione Lettera Screening: all'interno della sola entry/act/procedure (Livello Screening) DEVE essere presente l'elemento code con l'attributo @codeSystems valorizzato con il seguente OID "2.16.840.1.113883.6.1"</assert>
