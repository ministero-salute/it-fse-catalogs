...
<!--_______________________________________________________________HEADER _____________________________________________________________________-->
	...
	<!-- ClinicalDocument -->
		...
		<!--Controllo recordTarget/patientRole/patient/birthTime-->
			...
			count(hl7:recordTarget/hl7:patientRole/hl7:patient/hl7:birthTime[@value])=1"
			>ERRORE-17| L'elemento <name/>/recordTaget/patientRole/patient DEVE riportare un elemento 'birthTime' con @value valorizzato. Qualora non si possa risalire al dato, è possibile valorizzare l'elemento con @nullFlavor="UNK"</assert>	
...
<!--___________________________________________________________________BODY__________________________________________________________________________-->
		...
		<!--Controllo sulle Section obbligatorie-->
			...
			<assert test="count(hl7:component/hl7:section[hl7:code[@code='10157-6']]/hl7:entry)&gt;=1"
			>ERRORE-b17a| Sezione Anamnesi familiare: la sezione DEVE contenere un elemento 'entry'</assert>
		...
		<!--Controllo sulle Section opzionali-->
			...
			<assert test="count(hl7:component/hl7:section[hl7:code[@code='8716-3']])=0 or 
			count(hl7:component/hl7:section[hl7:code[@code='8716-3']]/hl7:entry)&gt;=1"
			>ERRORE-b37a| Sezione Parametri vitali: la sezione DEVE contenere almeno un elemento 'entry' </assert>
