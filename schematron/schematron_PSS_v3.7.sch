...
<!--___________________________________________________________________BODY__________________________________________________________________________-->
		...
		<!--Controllo sulle Section obbligatorie-->
			...
			<assert test="count($anamnesiObservation)=0 or count($anamnesiObservation/hl7:value[@xsi:type='CD' and @codeSystem='2.16.840.1.113883.11.22.9'])=1 "
			>ERRORE-b22| Sezione Anamnesi Familiare: entry/observation se presente l'elemento value DEVE contentere @xsi:type='CD' e @codeSystem='2.16.840.1.113883.11.22.9' </assert>
