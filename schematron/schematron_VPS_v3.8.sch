...
<!--________________________________ HEADER _____________________________________________________________-->
	...
	<!-- ClinicalDocument -->
		<rule context="hl7:ClinicalDocument">
			...
			>ERRORE-7| L'elemento <name/> DEVE contenere un solo elemento 'languageCode' con attributo code valorizzato</assert>
			...
			>ERRORE-9a| Un documento CDA2 conforme può avere o un relatedDocument con @typeCode='APND' | 'RPLC' | 'XFRM'; oppure una combinazione di due 'relatedDocument' con la seguente composizione:
			...
			>ERRORE-11a| L'elemento <name/>/recordTarget/patientRole/id  deve avere l'attributo @root valorizzato tramite uno dei seguenti identificatori Nazionali:
				...
				Oppure nel caso in cui l'identificativo sia rappresentato dal codice SASN (Assistenza sanitaria al personale navigante), il root sarà valorizzato con l'OID regionale specifico delle regioni che l'hanno definito.
			</assert>
			...
			>ERRORE-19| L'elemento <name/>/recordTarget/patientRole/patient/birthplace DEVE essere presente </assert>	
			...
			>ERRORE-19a| L'elemento <name/>/recordTarget/patientRole/patient/birthplace DEVE contenere un elemento place/addr/country </assert>
			...
			>ERRORE-19b| L'elemento <name/>/recordTarget/patientRole/patient/birthplace per i pazienti nati in Italia DEVE contenere gli elementi city e censusTract</assert>
			
			
			<!--Controllo dataEnterer-->	
			<assert test="count(hl7:dataEnterer)=0 or count(hl7:dataEnterer/hl7:time)=1 or count(hl7:dataEnterer/hl7:time[@nullFlavor])=1"
			>ERRORE-20| L'elemento <name/>/dataEnterer se presnete, DEVE contenere un elemento 'time', si deve utilizzare l'attributo @nullFlavor in caso di assenza del dato</assert>
			...
			<assert test="count(hl7:componentOf/hl7:encompassingEncounter/hl7:encounterParticipant)&lt;=1"
			>ERRORE-36a| L'elemento <name/>/componentOf/encompassingEncounter/ può contenere al massimo un elemento encounterParticipant</assert>
			
			<assert test="count(hl7:componentOf/hl7:encompassingEncounter/hl7:encounterParticipant)=0 or count(hl7:componentOf/hl7:encompassingEncounter/hl7:encounterParticipant[@typeCode='ADM'])=1"
			>ERRORE-36b| L'elemento <name/>/componentOf/encompassingEncounter/encounterParticipant se presente deve avere l'attributo typeCode valorizzato con 'ADM'</assert>
...
        <rule context="hl7:ClinicalDocument/hl7:documentationOf">
			<assert test ="count(hl7:serviceEvent/hl7:effectiveTime)=0 or (count(hl7:serviceEvent/hl7:effectiveTime/hl7:low)=1 and count(hl7:serviceEvent/hl7:effectiveTime/hl7:high)=1) "
			>ERRORE-44| Se presente l'elemento serviceEvent/effectiveTime, deve avere low e high valorizzati.</assert>
			
			<assert test="count(hl7:serviceEvent/hl7:performer)&lt;=1"
			>ERRORE-44a | L'elemento ClinicalDocument/documentationOf/serviceEvent può riportare al massimo un solo elemento performer.</assert>
...
<!--________________________________CONTROLLI GENERICI_________________________________________________________________-->
		...
		<rule context="//hl7:addr[
			...
			>ERRORE-46a| L'elemento <name/>  DEVE avere valorizzati gli elementi 'country', 'city', 'streetAddressLine'.</assert>
		</rule>
		...
		<rule context="//hl7:observation">
			...
			>ERRORE-47a| L'attributo "@classCode" dell'elemento "observation" deve essere valorizzato con "OBS" </assert>
		...
		<rule context="//hl7:assignedEntity">
			...
			>ERRORE-55| Qualora l'elemento <name/> contenga due elementi 'id', questi devono essere valorizzati come segue:
			...
			>ERRORE-56| L'elemento <name/> può contenere l'elemento addr che Deve contenere gli elementi country,city e streetAddressLine </assert>
...
<!--________________________________BODY____________________________________________________________________________-->
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody">
			...
			<assert test="count(hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:entry/hl7:act)=1"
			>ERRORE-b21a| Sezione Dimissione: deve essere presente almeno una entry/act relativa alla Dimissione</assert>
			...
			<!--Controllo 1° entry/act "Dimissione"-->
				...
				<assert test="count(hl7:component/hl7:section/hl7:code[@code='28574-2'])=0 or 
				count($act_discharge/hl7:performer/hl7:assignedEntity/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
				>ERRORE-b27a| Sezione Dimissione: l'entry/act/performer/assignedEntity/id DEVE contenere l'attributo @root='2.16.840.1.113883.2.9.4.3.2'</assert>
				...
				<!--entryRelationship/observation controllo incrociato tra Esito e Diagnosi per ammisibilità value Diagnosi con @code=6 o @code=7 -->
				<assert test="count(hl7:component/hl7:section/hl7:code[@code='28574-2'])=0 or (
				count($act_discharge/hl7:entryRelationship[hl7:observation/hl7:code[@code='29308-4']])&gt;=1 and count($act_discharge/hl7:entryRelationship/hl7:observation[hl7:code[@code='11302-7']]/hl7:value[@codeSystem='2.16.840.1.113883.2.9.6.1.54.5' and (@code!='6' or @code!='7')])=1 ) or (count($act_discharge/hl7:entryRelationship[hl7:observation/hl7:code[@code='29308-4']])=0 and count($act_discharge/hl7:entryRelationship/hl7:observation[hl7:code[@code='11302-7']]/hl7:value[@codeSystem='2.16.840.1.113883.2.9.6.1.54.5' and (@code='6' or @code='7')])=1 )"
				>ERRORE-b29|Sezione Dimissione(Diagnosi Dimissione): La compilazione della diagnosi è opzionale se e solo se l’esito trattamento assume uno dei seguenti valori:
				- 6. il paziente abbandona il pronto soccorso prima della visita medica;
				- 7. il paziente abbandona il pronto soccorso in corso di accertamenti e/o prima della chiusura della cartella clinica. </assert>
			...
			<!--Controllo 2° entry "Prognosi" (0..1)-->
				...
				<assert test="count($prognosi)=0 or count($prognosi/hl7:observation/hl7:effectiveTime)=1"
				>ERRORE-b36a| Sezione Dimissione: l'entry/observation "Prognosi" DEVE contenere un elemento effectiveTime</assert>
			...
			<!--Controllo 3° entry "Livello appropriatezza" (0..1)-->
				<let name="appropriatezza" value="hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:entry[hl7:observation/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.72']]"/>
				...
				<assert test="count($appropriatezza)=0 or count($appropriatezza/hl7:observation/hl7:code[@code='11283-9'][@codeSystem='2.16.840.1.113883.6.1'])=1"
				>ERRORE-b39| Sezione Dimissione: l'entry/observation "Livello di Appropriatezza" DEVE contenere un elemento 'code' valorizzato con @code='11283-9' @codeSystem='2.16.840.1.113883.6.1'</assert>
				...
				<assert test="count($appropriatezza)=0 or count($appropriatezza/hl7:observation/hl7:effectiveTime)=1"
				>ERRORE-b40a| Sezione Dimissione: l'entry/observation "Livello di Appropriatezza" DEVE contenere un elemento effectiveTime</assert>
			...
			<!--Controllo 4° entry "Data Decesso" (0..1)-->
				<let name="data_decesso" value="hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:entry[hl7:observation/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.86']]"/>
				...
				<assert test="count($data_decesso)=0 or count($data_decesso/hl7:observation/hl7:code[@code='31211-6'][@codeSystem='2.16.840.1.113883.6.1'])=1"
				>ERRORE-b43| Sezione Dimissione: l'entry/observation "Data Decesso" DEVE contenere un elemento 'code' valorizzato con @code='31211-6' @codeSystem='2.16.840.1.113883.6.1'</assert>
				
				<assert test="count($data_decesso)=0 or count($data_decesso/hl7:observation/hl7:effectiveTime)=1"
				>ERRORE-b43a| Sezione Dimissione: l'entry/observation "Data Decesso" DEVE contenere un elemento effectiveTime</assert>
			...
			<!--Controllo 5° entry "Richiesta Autopsia" (0..1)-->
				<let name="autopsia" value="hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:entry[hl7:observation/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.73']]"/>
				...
				<assert test="count($autopsia)=0 or count($autopsia/hl7:observation/hl7:code[@code='45477-7'][@codeSystem='2.16.840.1.113883.6.1'])=1"
				>ERRORE-b47| Sezione Dimissione: l'entry/observation "Richiesta Autopsia" DEVE contenere un elemento 'code' valorizzato con @code='45477-7' @codeSystem='2.16.840.1.113883.6.1'</assert>
		...
		<!--12.2 Controllo sui Template per Sezione (Dimissione) entry/observation/templateId-->
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:entry">
					
				<let name="observation" value="hl7:observation"/>
				<assert test="count($observation)=0 or count($observation/hl7:templateId)=0 or count($observation/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.66'])=1 or count($observation/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.72'])=1 or count($observation/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.73'])=1 or count($observation/hl7:templateId[@root='2.16.840.1.113883.2.9.10.1.6.86'])=1"
				>ERRORE-b75a| Sezione Dimissione: Il templateId '<value-of select="$observation/hl7:templateId"/>' non è corretto. La/Le entry/observation, se presente/i deve/devono essere valorizzata con uno dei seguenti codici:
				-2.16.840.1.113883.2.9.10.1.6.66 (Prognosi)
				-2.16.840.1.113883.2.9.10.1.6.72 (Livello Appropriatezza)
				-2.16.840.1.113883.2.9.10.1.6.73 (Richiesta Autopsia)
				-2.16.840.1.113883.2.9.10.1.6.86 (Data Decesso)
				</assert>
		</rule>
		<!--1-->
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='54094-8']]/hl7:entry">
			...
			<assert test="count(hl7:observation/hl7:effectiveTime)=0 or count(hl7:observation/hl7:effectiveTime[@value])=1"
			>ERRORE-b82a| Sezione Triage: l'elemento entry/observation/effectiveTime se presente DEVE contenere l'attributo @value</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='54094-8']]/hl7:entry/hl7:observation/hl7:performer">
				...
				>ERRORE-b84a|Sezione Triage: entry/observation/performer/assignedEntity deve contenere almeno un elemento id valorizzato con @root='2.16.840.1.113883.2.9.4.3.2' </assert>	
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component">
			...
			<!--Terapie Farmacologica all'ingresso-->
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:author">
			<assert test="count(hl7:assignedAuthor)=0 or
			count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b95a| Sezione Inquadramento clinico iniziale: l'elemento section/author/assignedAuthor/id deve essere valorizzato almeno con @root='2.16.840.1.113883.2.9.4.3.2'</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='11329-0']]/hl7:author">
			...
			<assert test="count(hl7:assignedAuthor)=0 or
			count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b96a| Sotto-Sezione Anamnesi: l'elemento section/author/assignedAuthor/id deve essere valorizzato almeno con @root='2.16.840.1.113883.2.9.4.3.2'</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='29545-1']]/hl7:author">
			...
			<assert test="count(hl7:assignedAuthor)=0 or
			count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b96b| Sezione Inquadramento clinico iniziale (Esame Obiettivo): l'elemento section/author/assignedAuthor/id deve essere valorizzato almeno con @root='2.16.840.1.113883.2.9.4.3.2'</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='42346-7']]/hl7:author">
			<assert test="count(hl7:assignedAuthor)=0 or
			count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b97a| Sezione Inquadramento clinico iniziale (Terapia Farmacologica all'ingresso): l'elemento section/author/assignedAuthor/id deve essere valorizzato almeno con @root='2.16.840.1.113883.2.9.4.3.2'</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='48765-2']]/hl7:author">
			...
			<assert test="count(hl7:assignedAuthor)=0 or
			count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b98a| Sezione Inquadramento clinico iniziale (Allergie): l'elemento section/author/assignedAuthor/id deve essere valorizzato almeno con @root='2.16.840.1.113883.2.9.4.3.2'</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='11450-4']]/hl7:author">
			...
			<assert test="count(hl7:assignedAuthor)=0 or
			count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b99a| Sezione Inquadramento clinico iniziale (Allergie): l'elemento section/author/assignedAuthor/id deve essere valorizzato almeno con @root='2.16.840.1.113883.2.9.4.3.2'</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='11329-0']]/hl7:entry">
				...
				<assert test="count(hl7:observation)=0 or count(hl7:observation/hl7:templateId)=0 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.316'])=1"
				>ERRORE-b101a| Sotto-sezione Anamnesi: l'elemento entry/observation/templateId  deve avere l'attributo @root='2.16.840.1.113883.3.1937.777.63.10.316'</assert>
				...
				<assert test="count(hl7:organizer)=0 or count(hl7:observation/hl7:templateId)=0 or count(hl7:organizer/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.317'])=1"
				>ERRORE-b110a| Sotto-sezione Anamnesi: l'elemento entry/observation/templateId  deve avere l'attributo @root='2.16.840.1.113883.3.1937.777.63.10.317'</assert>
				...
				<assert test="count(hl7:organizer)=0 or count(hl7:organizer/hl7:subject/hl7:relatedSubject/hl7:subject/hl7:name)=0 or (count(hl7:organizer/hl7:subject/hl7:relatedSubject/hl7:subject/hl7:name/hl7:given)=1 and count(hl7:organizer/hl7:subject/hl7:relatedSubject/hl7:subject/hl7:name/hl7:family)=1)"
				>ERRORE-b114a| Sotto-sezione Anamnesi: l'elemento entry/organizer/subject/relatedSubject/subject/name se presente deve avere gli attributi given e family </assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='11329-0']]/hl7:entry/hl7:observation/hl7:entryRelationship">
					...
					<assert test="count(@inversionInd)=0 or @inversionInd='false'"
					>ERRORE-b116a| L'attributo "@inversionInd" dell'elemento "entry/observation/entryRelationship se presente deve avere l'attributo @inversionInd="false"</assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='11329-0']]/hl7:entry/hl7:organizer/hl7:component">
					...
					<assert test="count(hl7:observation/hl7:templateId)=0 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.931'])=1"
					>ERRORE-b118b| Sotto-sezione Anamnesi: l'elemento entry/organizer/component/observation/templateId deve avere l'attributo @root='2.16.840.1.113883.3.1937.777.63.10.931'</assert>
					
					<assert test="count(hl7:observation/hl7:code[@codeSystem='2.16.840.1.113883.6.1'])=1 or count(hl7:observation/hl7:code[@codeSystem='2.16.840.1.113883.2.9.77.22.11.9'])=1"
					>ERRORE-b119| Sotto-sezione Anamnesi: l'elemento entry/organizer/component/observation/code deve avere l'attributo @codeSystem='2.16.840.1.113883.6.1' oppure @codeSystem='2.16.840.1.113883.2.9.77.22.11.9' </assert>
					<assert test="count(hl7:observation/hl7:statusCode[@code='completed'])=1"
					...
					<assert test="count(hl7:observation/hl7:effectiveTime[@value])=1 or count(hl7:observation/hl7:effectiveTime[@nullFlavor='UNK'])=1"
					>ERRORE-b121| Sotto-sezione Anamnesi: l'elemento entry/organizer/component/observation/effectiveTime deve essere presente, se non ne si conosce il valore deve essere valorizzato con @nullFlavor="UNK"</assert>
					...
					>ERRORE-b124| Sotto-sezione Anamnesi: l'elemento entry/organizer/component/observation può contenere una entryRelationship relativa all'Età di Decesso. </assert>
					
					<assert test="count(hl7:observation/hl7:entryRelationship[hl7:observation/hl7:code[@code='39016-1']])=0 or 
					...
					>ERRORE-b124b| Sotto-sezione Anamnesi: l'elemento entry/organizer/component/observation/entryRelationship/observation deve avere il code valorizzato con @code='39016-1' e deve contenere un elemento 'value'</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='48765-2']]/hl7:entry">
				...
				>ERRORE-b126a| Sezione Allergie: l'elemento entry/act/code deve essere presente e deve avere l'elemento 'code' valorizzato con @nullFlavor='NA'</assert>
				
				<assert test="count(hl7:act/hl7:templateId)=0 or count(hl7:act/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.319'])=1"
				>ERRORE-b126b| Sezione Allergie: l'elemento entry/act/code se presente deve avere l'elemento 'templateId' valorizzato con @root='2.16.840.1.113883.3.1937.777.63.10.319'</assert>
				
				<assert test="count(hl7:act/hl7:effectiveTime/hl7:low[@value])=1 or count(hl7:act/hl7:effectiveTime/hl7:low[@nullFlavor='UNK'])=1"
				>ERRORE-b127| Sezione Allergie: l'elemento entry/act/effectiveTime deve essere presente e deve avere l'elemento 'low' valorizzato oppure in caso il valore non sia noto valorizzare con @nullFlavor='UNK'</assert>
				...
				<assert test="count(hl7:act/hl7:entryRelationship/hl7:observation/hl7:templateId)=0 or count(hl7:act/hl7:entryRelationship/hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.320'])=1"
				>ERRORE-b130a| Sezione Allergie: l'elemento entry/act/entryRelationship/observation/templateId/@root se presente deve assumere il valore costante '2.16.840.1.113883.3.1937.777.63.10.320'</assert>
				...
				<assert test="count(hl7:act/hl7:entryRelationship/hl7:observation/hl7:effectiveTime/hl7:low[@value])=1 or count(hl7:act/hl7:entryRelationship/hl7:observation/hl7:effectiveTime/hl7:low[@nullFlavor='UNK'])=1 "
				>ERRORE-b132| Sezione Allergie: l'elemento entry/act/entryRelationship/observation/effectiveTime deve essere presente e deve avere l'elemento 'low' valorizzato in caso in cui non si conosca il valore utilizzare @nullFlavor='UNK'</assert>
				...
				>ERRORE-b134| Sezione Allergie: l'elemento entry/act/entryRelationship/observation/value codificato, deve avere l'attributo @code valorizzato secondo il value set "ObservationIntoleranceType" @codeSystem='2.16.840.1.113883.1.11.19700' oppure @codeSystem='2.16.840.1.113883.5.4'</assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='48765-2']]/hl7:entry/hl7:act/hl7:entryRelationship/hl7:observation/hl7:participant">
					...
					>ERRORE-b140| Sotto sezione Allergie: L'elemento participant/participantRole/playingEntity deve avere l'elemento code valorizzato con:
					...
					- Nel caso in cui l'agente sia descritto mediante codificia valorizzare @code e @codeSystem come segue:
				...
				<assert test="count(hl7:participantRole/hl7:playingEntity/hl7:code[@code])=1 or count(hl7:participantRole/hl7:playingEntity/hl7:code[@nullFlavor='UNK'])=1 or count(hl7:participantRole/hl7:playingEntity/hl7:code[@nullFlavor='NI']/hl7:originalText/hl7:reference)=1"
				>ERRORE-b140a| Sezione Allergie e Intolleranze: entry/act/entryRelationship/observation/participant/participantRole/playingEntity DEVE contenere l'elemento originalText/reference.</assert>
				</rule>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='48765-2']]/hl7:entry/hl7:act/hl7:entryRelationship/hl7:observation/hl7:entryRelationship[@typeCode='MFST']">	
					...
					<assert test="count(hl7:observation/hl7:templateId)=0 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.163'])=1"
					>ERRORE-b140b| Sezione Allergie (descrizione reazione): entry/act/entryRelationship/observation/entryRelationship/observation se presente, deve avere un elemento 'templateID' con @root='2.16.840.1.113883.3.1937.777.63.10.163'</assert>
					...
					<assert test="count(hl7:observation/hl7:effectiveTime/hl7:low[@value])=1 or count(hl7:observation/hl7:effectiveTime/hl7:low[@nullFlavor='UNK'])=1"
					>ERRORE-b141a| Sezione Allergie (descrizione reazione): entry/act/entryRelationship/observation/entryRelationship/observation deve avere un 'effectiveTime' che contiene l'elemento 'low' valorizzato qualora il valore non sia noto valorizzare @nullFlavor='UNK' </assert>
					
					
					<let name="status" value="hl7:observation/hl7:statusCode/@code"/>
					<assert test="($status='completed' and count(hl7:observation/hl7:effectiveTime/hl7:high)=1) or
						($status='aborted' and count(hl7:observation/hl7:effectiveTime/hl7:high)=1) or 
						($status='suspended' and count(hl7:observation/hl7:effectiveTime/hl7:high)=0) or 
						($status='active' and count(hl7:observation/hl7:effectiveTime/hl7:high)=0)"
					>ERRORE-b142| Sezione Allergie: l'elemento entry/observation/effectiveTime/high deve essere presente nel caso in cui lo 'statusCode' sia 'completed'oppure'aborted'</assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='48765-2']]/hl7:entry/hl7:act/hl7:entryRelationship/hl7:observation/hl7:entryRelationship[@typeCode='SUBJ'][hl7:observation]">
					...
					<assert test="count(hl7:observation/hl7:templateId)=0 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.321'])=1"
					>ERRORE-b145a| Sezione Allergie (criticità dell'allergia o intolleranza): entry/act/entryRelationship/observation/entryRelationship/observation/templateId se presente deve avere l'attributo @root='2.16.840.1.113883.3.1937.777.63.10.321'</assert>
					...
					<assert test="count(hl7:observation/hl7:value[@codeSystem='2.16.840.1.113883.2.9.77.22.11.6' or @codeSystem='2.16.840.1.113883.5.1063'])=1"
					>ERRORE-b148| Sezione Allergie (criticità dell'allergia o intolleranza): entry/act/entryRelationship/observation/entryRelationship/observation/value Può essere valorizzato secondo il value set "CriticalityObservation" @codesystem='2.16.840.1.113883.2.9.77.22.11.6' oppure tramite il codesystem='2.16.840.1.113883.5.1063'</assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='48765-2']]/hl7:entry/hl7:act/hl7:entryRelationship/hl7:observation/hl7:entryRelationship[@typeCode='REFR']">
					...
					<assert test="count(hl7:observation/hl7:templateId)=0 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.916'])=1"
					>ERRORE-b148a| Sezione Allergie (stato dell'allergia): entry/act/entryRelationship/observation/entryRelationship/observation/templateId deve avere l'attributo @root'2.16.840.1.113883.3.1937.777.63.10.916'</assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='78337-3']]/hl7:component/hl7:section[hl7:code[@code='48765-2']]/hl7:entry/hl7:act/hl7:entryRelationship/hl7:observation/hl7:entryRelationship[@typeCode='SUBJ'][hl7:act]">
					...
					<assert test="count(hl7:act/hl7:templateId)=0 or count(hl7:act/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.920'])=1"
					>ERRORE-b150b| Sezione Allergie (commenti): l'elemento entry/act/entryRelationship/observation/entryRelationship/act/templateId se presente deve contenere l'elemento @root='2.16.840.1.113883.3.1937.777.63.10.920'</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='46240-8']]/hl7:entry">
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='46240-8']]/hl7:entry/hl7:encounter/hl7:participant[@typeCode='ADM']">
				<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
				>ERRORE-b155| Sezione Encounters: l'elemento entry/encounter/participant DEVE contenere l'elemento patientRole caratterizzato da un id obbligatorio con root=2.16.840.1.113883.2.9.4.3.2 </assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='46240-8']]/hl7:entry/hl7:encounter/hl7:participant[@typeCode='ATND']">
				<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
				>ERRORE-b157| Sezione Encounters: l'elemento entry/encounter/participant DEVE contenere l'elemento patientRole caratterizzato da un id obbligatorio con root=2.16.840.1.113883.2.9.4.3.2</assert>
				<assert test="count(hl7:participantRole/hl7:playingEntity)=0 or 
				count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:given)=1 and count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:family)=1"
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='46240-8']]/hl7:entry/hl7:encounter/hl7:participant[@typeCode='DIS']">
				<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
				>ERRORE-b159| Sezione Encounters: l'elemento entry/encounter/participant DEVE contenere l'elemento patientRole caratterizzato da un id obbligatorio con root=2.16.840.1.113883.2.9.4.3.2</assert>
				<assert test="count(hl7:participantRole/hl7:playingEntity)=0 or 
				count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:given)=1 and count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:family)=1"
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='8648-8']]/hl7:author">
			...
			<assert test="count(hl7:assignedAuthor)=0 or
			count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b165a| Sezione Decorso Ospedaliero: l'elemento section/author/assignedAuthor/id deve essere valorizzato almeno con @root='2.16.840.1.113883.2.9.4.3.2'</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='55109-3']]/hl7:entry">
			<assert test="count(hl7:observation/hl7:templateId)=0 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.323'])=1"
			>ERRORE-b166a| Sezione Complicanze: l'elemento entry/observation/templateId se presente DEVE essere valorizzato con @root='2.16.840.1.113883.3.1937.777.63.10.323'</assert>
		...
		<!--Complicanze: controllo sull'author-->
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='55109-3']]/hl7:author">
			
			<assert test="count(hl7:assignedAuthor)=0 or
			count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b168a| Sezione Complicanze: l'elemento section/author/assignedAuthor/id deve essere valorizzato almeno con @root='2.16.840.1.113883.2.9.4.3.2'</assert>
			
			<assert test="count(hl7:assignedAuthor/hl7:assignedPerson)=0 or
			(count(hl7:assignedAuthor/hl7:assignedPerson/hl7:name/hl7:given)=1 and count(hl7:assignedAuthor/hl7:assignedPerson/hl7:name/hl7:family)=1)"
			>ERRORE-b168b| Sezione Complicanze: l'elemento author/assignedAuthor/assignedPerson/name deve contenere i sotto elementi 'given' e 'family'</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='62387-6']]/hl7:entry">
			...
			<assert test="count(hl7:act/hl7:effectiveTime)=0 or count(hl7:act/hl7:effectiveTime[@value])=1"
			>ERRORE-b172a| Sezione Interventi Prestazioni Consulenze e Richieste: l'elemento entry/act/effectiveTime  se presenteDEVE contenere l'attributo value.</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='62387-6']]/hl7:entry/hl7:act/hl7:performer">
				...
				<assert test="count(hl7:assignedEntity/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1 "
				>ERRORE-b173a| Sezione Interventi Prestazioni Consulenze e Richieste: almeno un elemento entry/act/performer/assignedEntity/id  DEVE avere @root='2.16.840.1.113883.2.9.4.3.2' .</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='62387-6']]/hl7:entry/hl7:act/hl7:participant">		
				...
				<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])"
				>ERRORE-b175a| Sezione Interventi Prestazioni Consulenze e Richieste: l'elemento entry/act/participant DEVE contenere almeno un elemento participantRole/id con @root='2.16.840.1.113883.2.9.4.3.2'.</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='30954-2']]/hl7:entry">
			...
			>ERRORE-b180| Sezione Accertamenti: l'elemento entry/organizer/participant se presente DEVE contenere l'attributo @typeCode='REF'</assert>
			
			<assert test="count(hl7:organizer/hl7:component[hl7:observation])&gt;=1"
			>ERRORE-b180a| Sezione Accertamenti: Deve essere presente almeno un elemento entry/organizer/component/observation</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='30954-2']]/hl7:entry/hl7:organizer/hl7:performer">
				...
				<assert test="count(hl7:assignedEntity/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1 "
				>ERRORE-b180b| Sezione Accertamenti: almeno un elemento entry/act/performer/assignedEntity/id  DEVE avere @root='2.16.840.1.113883.2.9.4.3.2' .</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='30954-2']]/hl7:entry/hl7:organizer/hl7:participant">	
				...
				<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
				>ERRORE-b182a| Sezione Accertamenti: l'elemento entry/act/participant DEVE contenere almeno un elemento participantRole/id con @root='2.16.840.1.113883.2.9.4.3.2'.</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='30954-2']]/hl7:entry/hl7:organizer/hl7:component">	
				...
				<assert test="count(hl7:observation/hl7:effectiveTime[@value])=1"
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='8716-3']]/hl7:entry">
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='8716-3']]/hl7:entry/hl7:organizer/hl7:component/hl7:observation/hl7:performer">
				...
				<assert test="count(hl7:assignedEntity/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1 "
				>ERRORE-b197a| Sezione Interventi Prestazioni Consulenze e Richieste: almeno un elemento entry/act/performer/assignedEntity/id  DEVE avere @root='2.16.840.1.113883.2.9.4.3.2' .</assert>
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='8716-3']]/hl7:entry/hl7:organizer/hl7:component/hl7:observation/hl7:participant">
				...
				<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
				>ERRORE-b199a| Sezione Parametri Vitali: l'elemento entry/act/participant DEVE contenere almeno un elemento participantRole/id con @root='2.16.840.1.113883.2.9.4.3.2'.</assert>
				<assert test="count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:family)=1 and count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:given)=1"
			...
			<!--10.4-->
			<!--performer-->
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='8716-3']]/hl7:entry/hl7:organizer/hl7:performer">
				
				<assert test="count(hl7:assignedEntity/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1 "
				>ERRORE-b200a| Sezione Parametri Vitali: almeno un elemento entry/act/performer/assignedEntity/id  DEVE avere @root='2.16.840.1.113883.2.9.4.3.2' .</assert>
				
				<assert test="count(hl7:assignedEntity/hl7:assignedPerson/hl7:name/hl7:given)=1 and count(hl7:assignedEntity/hl7:assignedPerson/hl7:name/hl7:family)=1"
				>ERRORE-b200b| Sezione Parametri Vitali: l'elemento entry/organizer/performer/assignedEntity/assignedPerson/name DEVE contenere gli elementi 'given' e 'family'.</assert>
			</rule>
			
			<!--10.5-->
			<!--participant-->
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='8716-3']]/hl7:entry/hl7:organizer/hl7:participant">	
				<assert test="(count(hl7:participantRole/hl7:id)&gt;=1)"
				>ERRORE-b200c| Sezione Parametri Vitali: l'elemento entry/organizer/participant se presente DEVE contenere almeno un elemento participantRole/id</assert>
				
				<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
				>ERRORE-b200d| Sezione Parametri Vitali: l'elemento entry/act/participant DEVE contenere almeno un elemento participantRole/id con @root='2.16.840.1.113883.2.9.4.3.2'.</assert>
				
				<assert test="count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:given)=1 and count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:family)=1"
				>ERRORE-b200e| Sezione Parametri Vitali: l'elemento entry/organizer/participant/playingEntity/name DEVE contenere gli elementi 'given' e 'family' </assert>		
			</rule>	
			...
			<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='29549-3']]/hl7:entry">
				...
				>ERRORE-b204| Sezione Terapia Farmacologica in Pronto Soccorso: l'elemento entry/substanceAdministration/effectiveTime deve avere l'elemento 'low' valorizzato in caso non si disponga di questa informazione utilizzare @nullFlavor='UNK'</assert>
				...
				<assert test="count(hl7:substanceAdministration/hl7:entryRelationship/hl7:supply)&lt;=1"
				>ERRORE-b207a| Sezione Terapia Farmacologica in Pronto Soccorso: può contenere al massimo un elemento di tipo substanceAdministration/entryRelationship/supply (Numero Confezioni)</assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='29549-3']]/hl7:entry/hl7:substanceAdministration/hl7:performer">
					...
					<assert test="count(hl7:assignedEntity/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1 "
					>ERRORE-b208a| Sezione Terapia Farmacologica in Pronto Soccorso: almeno un elemento entry/act/performer/assignedEntity/id  DEVE avere @root='2.16.840.1.113883.2.9.4.3.2' .</assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='29549-3']]/hl7:entry/hl7:substanceAdministration/hl7:participant">
					...
					<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
					>ERRORE-b210a| Sezione Terapia Farmacologica in PS: l'elemento entry/act/participant DEVE contenere almeno un elemento participantRole/id con @root='2.16.840.1.113883.2.9.4.3.2'.</assert>
				...
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='29549-3']]/hl7:entry/hl7:substanceAdministration/hl7:entryRelationship">
					...
					<assert test="count(hl7:observation/hl7:templateId)=0 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.922'])=1 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.921'])=1 or count(hl7:supply/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.924'])=1"
					>ERRORE-b212a| Sezione Terapia farmacologica in Pronto Soccorso: entry/substanceAdministration/entryRelationship può contenere i seguenti templateId:
					- 2.16.840.1.113883.3.1937.777.63.10.922 [Observation/Quantità nella confezione]
					- 2.16.840.1.113883.3.1937.777.63.10.921 [Observation/Grammatura]
					- 2.16.840.1.113883.3.1937.777.63.10.924 [Supply/Numero di confezioni]	
					</assert>
					
					<assert test="count(hl7:observation/hl7:value)=1 or count(hl7:supply/hl7:quantity)=1"
					>ERRORE-b212b| Sezione Terapia farmacologica in Pronto Soccorso: entry/substanceAdministration/entryRelationship deve contentere i seguenti elementi: 
					- observation/value (Quantità nella confezione e Grammatura)
					- supply/quantity (Numero di confezioni)
					</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:entry/hl7:act[hl7:code[@code='dimissione']]/hl7:entryRelationship[hl7:encounter]">
			...
			<report test="not(count(hl7:encounter[@moodCode='EVN'])=1)"
			>W003| Valorizzare l'attributo @moodCode (Post Dimissione) con 'EVN' se evento già avvenuto o in corso.</report>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='28574-2']]/hl7:entry/hl7:act[hl7:code[@code='dimissione']]/hl7:entryRelationship[hl7:act]">
			...
			<report test="not(count(hl7:act[@moodCode='EVN'])=1)"
			>W004| Valorizzare l'attributo (Trasferimento Post Dimissione) @moodCode con 'EVN' se evento già avvenuto o in corso.</report>
			...
			<assert test="count(hl7:act/hl7:code[@nullFlavor='NA'])=1"				
			>ERRORE-b227a| Sezione Dimissione - "Trasferimento post dimissione": l'elemento entry/act/entryRelationship/act deve contenere l'elemento 'code' con @nullFlavor='NA'  </assert>
		...
		<!-- 13.1 Sezione Piano di cura alla dimissione: controllo entry-->
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='18776-5']]/hl7:entry/hl7:act/hl7:reference">
			
			
			
			<assert test="(count(hl7:externalAct/@moodCode)=1 and 
			count(hl7:externalAct/@classCode)=1)"
		...
		<!--13 Piano di Cura section/author-->
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='18776-5']]/hl7:author">
			<assert test="count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b245a| Sezione Piano di cura alla dimissione: l'elemento author/assignedAuthor/id con @root='2.16.840.1.113883.2.9.4.3.2' </assert>	
		...
		<!--13.1 Piano di Cura section/entry/act/author-->
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='18776-5']]/hl7:entry/hl7:act/hl7:author">
			...
			<assert test="count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b246a| Sezione Piano di cura alla dimissione: l'elemento author/assignedAuthor/id con @root='2.16.840.1.113883.2.9.4.3.2' </assert>	
		...
		<!-- 14 Terapia farmacologica alla dimissione section/author-->
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='75311-1']]/hl7:author">
			<assert test="count(hl7:assignedAuthor/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b247a| Sezione Piano di cura alla dimissione: l'elemento author/assignedAuthor/id con @root='2.16.840.1.113883.2.9.4.3.2' </assert>	
		...
		<!-- 14 Terapia farmacologica alla dimissione section/substanceAdministration-->
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='75311-1']]/hl7:entry">
			...
			<assert test="count(hl7:substanceAdministration/hl7:effectiveTime[@xsi:type='IVL_TS']/hl7:low)=1 or count(hl7:substanceAdministration/hl7:effectiveTime[@xsi:type='IVL_TS']/hl7:low[@nullFlavor='UNK'])=1 "
			>ERRORE-b252|Sezione Terapia farmacologica alla dimissione: entry/substanceAdministration/effectiveTime deve avere l'elemento 'low' valorizzato qualora non si conosca il valore, utilizzare @nullFlavor='UNK' </assert>
				...
				>ERRORE-b252a| Sezione Terapia farmacologica alla dimissione: l'elemento entry/substanceAdministration/effectiveTime/high deve essere presente nel caso in cui lo 'statusCode' sia 'completed'oppure'aborted'</assert-->
			...
			<assert test="count(hl7:substanceAdministration/hl7:entryRelationship/hl7:supply)&lt;=1"
			>ERRORE-b257a| Sezione Terapia Farmacologica alla dimissione:può contenere al massimo un elemento di tipo substanceAdministration/entryRelationship/supply (Numero Confezioni)</assert>
		
		<!--14 Terapia Farmacologica alla dimissione substanceAdministration/participant-->
		</rule>	
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='75311-1']]/hl7:entry/hl7:substanceAdministration/hl7:participant">
			...
			<assert test="count(hl7:participantRole/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=1"
			>ERRORE-b258a| Sezione Terapia Farmacologica alla dimissione: l'elemento entry/substanceAdministration/participant/id con @root='2.16.840.1.113883.2.9.4.3.2' </assert>	
			
			<assert test="count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:given)=1 and count(hl7:participantRole/hl7:playingEntity/hl7:name/hl7:family)=1"
			>ERRORE-b259| Sezione Terapia Farmacologica alla dimissione: se presente entry/substanceAdministration/participant, DEVE contenere l'elemento participantRole/playingEntity/name con i rispettivi sottoelementi 'family' e 'given'.</assert>
		</rule>
		
		<!--14 Terapia Farmacologica alla dimissione substanceAdministration/reference-->
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='75311-1']]/hl7:entry/hl7:substanceAdministration/hl7:reference">
			...
			<!--Terapia farmacologica alla dimissione: controllo sotto-elementi di entryRelationship-->
				<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='75311-1']]/hl7:entry/hl7:substanceAdministration/hl7:entryRelationship">
					
					<assert test="count(hl7:observation)=1 or count(hl7:supply)=1"
					>ERRORE-b263| Sezione Terapia farmacologica alla dimissione: entry/substanceAdministration/entryRelationship  deve contenere un elemento di tipo "observation" o "supply" </assert>
					
					
					<assert test="count(hl7:observation/hl7:templateId)=0 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.922'])=1 or count(hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.921'])=1 or count(hl7:supply/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.924'])=1"
					>ERRORE-b264| Sezione Terapia farmacologica alla dimissione: entry/substanceAdministration/entryRelationship può contenere i seguenti templateId:
					- 2.16.840.1.113883.3.1937.777.63.10.922 [Observation/Quantità nella confezione]
					- 2.16.840.1.113883.3.1937.777.63.10.921 [Observation/Grammatura]
					- 2.16.840.1.113883.3.1937.777.63.10.924 [Supply/Numero di confezioni]	
					</assert>
					...
					<assert test="count(hl7:observation/hl7:value)=1 or count(hl7:supply/hl7:quantity)=1"
					>ERRORE-b265| Sezione Terapia farmacologica alla dimissione: entry/substanceAdministration/entryRelationship deve contentere i seguenti elementi: 
					- observation/value (Quantità nella confezione e Grammatura)
					- supply/quantity (Numero di confezioni)
					</assert>
