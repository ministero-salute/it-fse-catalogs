...
<!--_______________________________________________________________HEADER _____________________________________________________________-->
		...
		<rule context="hl7:ClinicalDocument">
			...
			- 108276-7 Screening invitation letter;
			- 108274-2 Preventive medicine screening reminder letter. </assert>
...
<!--__________________________________________________BODY__________________________________________________________________________-->
		...
		<!--Controlli sulle sezioni obbligatorie-->
			...
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941'])=1"
			>ERRORE-b1| Sezione Lettera Screening: DEVE essere presente un'unica sezione con templateId/@root valorizzato con il seguente OID "2.16.840.1.113883.3.1937.777.63.10.941"</assert>				
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941'])=0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:code[@code='112071-6' and @codeSystem='2.16.840.1.113883.6.1'])=1"
			...
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941'])=0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:text)=1"
			...
			<assert test="
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:encounter)=0
			  or
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:encounter[@moodCode='APT'])=1">
			...
			<assert test="
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:encounter)=0
			  or			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:encounter/hl7:effectiveTime[@value or @nullFlavor='UNK'])=1">
			...
			<assert test="
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:encounter/hl7:entryRelationship)=0
			  or
			  count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:encounter/hl7:entryRelationship/hl7:observation/hl7:code[@code='ASSERTION'][@codeSystem='2.16.840.1.113883.5.4'])=1">
			...
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941'])=0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.614']])>=1"  
			...
			<assert test="count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry) = 0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:act[hl7:code[@codeSystem='2.16.840.1.113883.6.1' and (@code='108273-4' or @code='LA32760-3' or @code='LA32759-5') or (@nullFlavor='UNK')]])=1" 
			...
			<assert test="count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry) = 0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.614']]/hl7:text)=1" 
			...
			<assert test="count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry) = 0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.614']]/hl7:entryRelationship)=1" 
			...
			<assert test="count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry) = 0 or count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.941']]/hl7:entry/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.614']]/hl7:entryRelationship/hl7:procedure/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.623'])=1" 
