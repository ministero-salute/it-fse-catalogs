...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
	...
	<!-- ClinicalDocument -->
		...
		<rule context="hl7:ClinicalDocument/hl7:inFulfillmentOf">
            ...
            >ERRORE-39| <name/>/order/priorityCode DEVE avere l'attributo '@codeSystem='2.16.840.1.113883.5.7' </assert>
		</rule>
	...
	<!--________________________________ BODY _____________________________________________________________-->	
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='11329-0']]/hl7:component/hl7:section[hl7:code[@code='48765-2']]/hl7:entry/hl7:act/hl7:entryRelationship/hl7:observation/hl7:participant">
			...
			<assert test="count(hl7:participantRole/hl7:playingEntity/hl7:code[@nullFlavor='UNK' and not(@code or @codeSystem or @codeSystemName or @displayName)])=1 or
				...
				count(hl7:participantRole/hl7:playingEntity/hl7:code[@code and @codeSystem='2.16.840.1.113883.2.9.77.22.11.2' and not(@nullFlavor)])=1 or (count(hl7:participantRole/hl7:playingEntity/hl7:code[@nullFlavor and not(@code or @codeSystem or @codeSystemName or @displayName)])=1 and count(hl7:participantRole/hl7:playingEntity/hl7:code/hl7:originalText/hl7:reference)=1 )"
				>ERRORE-b58| Sotto sezione Allergie: L'elemento participant/participantRole/playingEntity deve avere l'attributo code valorizzato con code/@codeSystem valorizzato come segue:
				...
				Oppure  nel caso in cui non è noto l'agente della reazione allergica @nullFlavor='UNK'
				Oppure nel caso in cui l'agente non è individuabile tramite codifica è necessario valorizzare il code con @nullFlavor e inserire l'elemento originalText/reference
			</assert>
		</rule>
