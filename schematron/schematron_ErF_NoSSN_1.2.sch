...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
	...
	<!--________________________________ HEADER _____________________________________________________________-->
		...
		<rule context="//hl7:entryRelationship[
				...
				and not(
					...
					hl7:act[hl7:templateId/@root='2.16.840.1.113883.3.1937.777.63.10.938']/
	...
	<!--__________________________________________BODY__________________________________________-->
		...
		<!-- 1. EROGAZIONE FARMACEUTICA NON SSN-->
			<assert test="count(hl7:component/hl7:section/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.936'])=1"
			>ERRORE-b1| Sezione Erogazione Farmaceutica non SSN: La sezione DEVE contenere l'elemento 'templateId' e DEVE essere presente l'attributo @root valorizzato con '2.16.840.1.113883.3.1937.777.63.10.936'.</assert>
			...
			<assert test="count(hl7:component/hl7:section[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.936']]/hl7:text)=1"
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section/hl7:entry">
			...
			<assert test="count(hl7:supply/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.937'])=1"
			>ERRORE-b10| Sezione Erogazione Farmaceutica non SSN: L'elemento <name/>/supply deve contenere l'elemento 'templateId' con l'attributo @root valorizzato con '2.16.840.1.113883.3.1937.777.63.10.937'.</assert>
		...
		<!-- entryRelationship Act_Variazione Farmaco-->	
			<assert test="count(hl7:supply/hl7:entryRelationship[hl7:act])=0 or count(hl7:supply/hl7:entryRelationship/hl7:act/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.938'])=1"
			>ERRORE-b18| Sezione Erogazione Farmaceutica non SSN: L'elemento supply/entryRelationship di tipo act(Variazione Farmaco), se presente, deve contenere l'elemento templateId con l'attributo @root valorizzato con '2.16.840.1.113883.3.1937.777.63.10.938'.</assert>
				
			<assert test="count(hl7:supply/hl7:entryRelationship/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.938']])=0 or count(hl7:supply/hl7:entryRelationship/hl7:act[hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.938']]/hl7:code[(@code='S' and @codeSystem='2.16.840.1.113883.3.1937.777.63.11.16') or @nullFlavor='UNK'])=1"
			>ERRORE-b19| Sezione Erogazione Farmaceutica non SSN: L'elemento supply/entryRelationship di tipo act (Variazione Farmaco), se presente, deve contenere l'elemento 'code' valorizzato con uno dei seguenti valori:
			- @nullFlavor="UNK" se il campo è vuoto;
			- @code="S" e @codeSystem="2.16.840.1.113883.3.1937.777.63.11.16" se il farmaco per cui il medico aveva espresso la clausola di non sostituibilità viene sostituito in fase di erogazione.
			</assert>
			...
			<assert test="count(hl7:supply/hl7:entryRelationship[hl7:act])=0 or count(hl7:supply/hl7:entryRelationship/hl7:act/hl7:entryRelationship/hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.939'])=1"
		    >ERRORE-b22| Sezione Erogazione Farmaceutica non SSN: L'elemento supply/entryRelationship/act/entryRelationship/observation deve contenere l'elemento 'templateId' con l'attributo @root='2.16.840.1.113883.3.1937.777.63.10.939'.</assert>
