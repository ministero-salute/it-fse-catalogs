...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
	...
	<!--________________________________ HEADER _____________________________________________________________-->
		...
		<rule context="hl7:ClinicalDocument">
			...
			<assert test = "(count(hl7:dataEnterer/hl7:assignedEntity/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=0 and (count(hl7:dataEnterer/hl7:assignedEntity/hl7:id[matches(@root, '^2\.16\.840\.1\.113883\.2\.9\.2\.(10|20|30|41|42|50|60|70|80|90|100|110|120|130|140|150|160|170|180|190|200)\.4\.2$')])=1)) or
			...
			<assert test = "(count(hl7:legalAuthenticator/hl7:assignedEntity/hl7:id[@root='2.16.840.1.113883.2.9.4.3.2'])=0 and (count(hl7:legalAuthenticator/hl7:assignedEntity/hl7:id[matches(@root,'^2\.16\.840\.1\.113883\.2\.9\.2\.(10|20|30|41|42|50|60|70|80|90|100|110|120|130|140|150|160|170|180|190|200)\.4\.2$')])=1)) or
	...
	<!--__________________________________________BODY__________________________________________-->
		...
		<!-- entryRelationship Act_Messaggio Regionale-->
			<assert test="count(hl7:supply/hl7:entryRelationship[hl7:act])=0 or count(hl7:supply/hl7:entryRelationship/hl7:act/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.818'])=1"
