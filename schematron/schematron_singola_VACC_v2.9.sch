...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
	...
	<!-- ClinicalDocument -->
		...
		<rule context="hl7:ClinicalDocument/hl7:author">
			...
			>ERRORE-29| L'elemento <name/>/assignedAuthor/representedOrganization/addr DEVE riportare i sotto-elementi 'country','city' e 'streetAddressLine'</assert-->
	...
	<!--__________________________________________________________CONTROLLI GENERICI________________________________________________________________-->
		...
		<rule context="//hl7:name[not(parent::hl7:informationRecipient) and not(parent::hl7:patient) and not(contains(local-name(..), 'Person'))]">
			...
			>ERRORE-38| L’elemento 'name' di una organizzazione non deve contenere i sotto elementi 'delimiter', 'prefix', 'suffix'.</assert>
		</rule>
		...
		<rule context="//hl7:effectiveTime[hl7:low]">
			...
			>ERROR-40| Il valore dell'elemento effectiveTime/high : '<value-of select="$effective_time_high"/>' 
