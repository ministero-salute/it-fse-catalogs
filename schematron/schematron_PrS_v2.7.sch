...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
        ...
        queryBinding="xslt2">
	<title>Schematron Prescrizione Specialistica 2.7</title>
	...
	<!--________________________________ HEADER _____________________________________________________________-->
		...
		<rule context="hl7:ClinicalDocument">
			...
			>ERRORE-13b| Un documento CDA2 conforme può avere o un relatedDocument con @typeCode='APND' | 'RPLC' | 'XFRM'; oppure una combinazione di due relatedDocument con la seguente composizione:
			...
			count(hl7:recordTarget/hl7:patientRole/hl7:addr[@use='H'])=1 or count(hl7:recordTarget/hl7:patientRole/hl7:addr[@use='TMP'])=$num_addr)"
			...
			>ERRORE-26| L'elemento <name/>/recordTaget/patientRole/patient DEVE riportare un elemento 'birthTime'. Qualora non si possa risalire al dato, è possibile valorizzare l'elemento con @nullFlavor="UNK"</assert>	
		...
		<rule context="hl7:ClinicalDocument/hl7:author">
			...
			<!-- controllo author/assignedAuthor/representedOrganization -->
			...
			>ERRORE-50| L'elemento <name/>/assignedAuthor/representedOrganization, se presente, DEVE contenere un attributo @classCode valorizzato con 'ORG'</assert>
	...
	<rule context="hl7:ClinicalDocument/hl7:participant">
		...
		count(hl7:associatedEntity/hl7:scopingOrganization[@classCode])=1"
		>ERRORE-59| L'elemento <name/>/associatedEntity/scopingOrganization, se presente, DEVE avere l'attributo @classCode valorizzato con 'ORG'</assert>
	...
	<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody">
		...
		<assert test="count(hl7:component/hl7:section[hl7:code[@code='57827-8']]/hl7:entry/hl7:act[@classCode='ACT' and @moodCode='EVN'])=1">
			ERRORE-b4a| Sezione Esenzioni: L'elemento entry/act DEVE contenere l'attributo @classCode valorizzato con 'ACT' e l'attributo @moodCode valorizzato con 'EVN'.</assert>
		...
		ERRORE-b10| Sezione Prescrizioni: La sezione DEVE contenere almeno un elemento entry</assert>
		...
		ERRORE-b17| Sezione Parametri Vitali: La sezione, se presente, deve contenere l'elemento templateId con l' attributo @root valorizzato con '2.16.840.1.113883.3.1937.777.63.10.263' </assert>
	...
	<!-- 2.1 controllo entry -->
	<!-- Prescrizione - controllo entry/observation -->
	<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='57828-6']]/hl7:entry">
		...
		<assert test="(count(hl7:observation[@classCode])=0 or count(hl7:observation[@classCode='OBS'])=1) and count(hl7:observation[@moodCode='RQO'])=1">
		...
		<assert test="count(hl7:observation/hl7:entryRelationship[@typeCode='SUBJ']/@inversionInd)=0 or count(hl7:observation/hl7:entryRelationship[@typeCode='SUBJ'][@inversionInd='true'])=1"
		>ERRORE-b32a| Sezione Prescrizioni: L'elemento entry/observation/entryRelationship può contenere l'attributo @inversionInd valorizzato con 'true'.</assert>
		...
		>ERRORE-b38| Sezione Prescrizioni: L'elemento entry/observation/entryRelationship/encounter DEVE contenere gli attributi @moodCode e @classCode valorizzati rispettivamente con 'INT' e 'ENC'</assert>
		...
		>ERRORE-b39| Sezione Prescrizioni: L'elemento entry/observation/entryRelationship/encounter DEVE contenere al più un elemento templateId con l'attributo @root valorizzato con '2.16.840.1.113883.3.1937.777.63.10.281'</assert>
		<assert test="count(hl7:observation/hl7:entryRelationship[@typeCode='REFR']/hl7:encounter/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.281'])=0 or
		...
		>ERRORE-b41| Sezione Prescrizioni: L'elemento entry/observation/entryRelationship, se presente, deve avere l'elemento act con gli attributi @classCode='ACT' e @moodCode='EVN'</assert>
		<assert test="count(hl7:observation/hl7:entryRelationship[@typeCode='AUTH'])=0 or
		...
		>Errore-b44|Sezione Prescrizioni: L'elemento entry/observation/entryRelationship/act/code/translation/qualifier, se presente, DEVE contenere l'elemento value con l'attributo @codeSystems valorizzato come '2.16.840.1.113883.2.9.6.1.55'.</assert>
	...
	<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='57828-6']]/hl7:entry/hl7:observation/hl7:entryRelationship[@typeCode = 'REFR'][hl7:encounter/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.276']]">
		...
		>ERRORE-b50| Sezione Prescrizioni: L'elemento entry/observation/entryRelationship/encounter DEVE contenere gli attributi valorizzati con @classCode='ENC' e @moodCode='INT'</assert>
