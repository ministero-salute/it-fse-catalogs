...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
	...
	<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody">
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='57828-6']]/hl7:entry">
			<assert test="count(hl7:substanceAdministration[@moodCode = 'RQO'])=1">
			ERRORE-b18|Sezione Prescrizioni: L'elemento entry/substanceAdministration deve avere l'attributo @moodCode valorizzato con 'RQO'</assert>
			<!--IVL_TS-->
			...
			ERRORE-b34| Sezione Prescrizioni: L'elemento entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial/formCOde deve avere gli attributi @code e @codeSystem valorizzati.</assert>
				...
				count(hl7:substanceAdministration/hl7:entryRelationship[@typeCode='RSON'][hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.77.1']])=1"
				>ERRORE-b40a| Sezione Prescrizioni: L'elemento entry/substanceAdministration/entryRelationship (sospetto diagnostico in testo libero), se presente, DEVE contenere l'attributo @typeCode valorizzato con @typeCode='RSON'.</assert>
				<assert test="count(hl7:substanceAdministration/hl7:entryRelationship/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.77.1'])=0 or 
				...
				count(hl7:substanceAdministration/hl7:entryRelationship[ @typeCode='SUBJ' and (not(@inversionInd) or @inversionInd='true')][hl7:observation])=1"
				>ERRORE-b45| Sezione Prescrizioni: L'elemento entry/substanceAdministration/entryRelationship (motivo non sostituibilità)può avere l'attributo @inversionInd='true'.</assert>
				<assert test="count(hl7:substanceAdministration/hl7:entryRelationship[@typeCode='SUBJ'][hl7:observation])=0 or 
				...
				<assert test="count(hl7:substanceAdministration/hl7:entryRelationship[@typeCode='SUBJ'][hl7:observation])=0 or 
				count(hl7:substanceAdministration/hl7:entryRelationship[@typeCode='SUBJ']/hl7:observation/hl7:code[@code='N' and @codeSystem='2.16.840.1.113883.3.1937.777.63.11.26'])=1"
				>ERRORE-b47| Sezione Prescrizioni: L'elemento entry/substanceAdministration/entryRelationship/observation (motivo non sostituibilità), DEVE contenere l'elemento 'code' valorizzato con @code='N' e @codeSystem='2.16.840.1.113883.3.1937.777.63.11.26'.</assert>
				<assert test="count(hl7:substanceAdministration/hl7:entryRelationship[@typeCode='SUBJ'][hl7:observation])=0 or 
