...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
        ...
        queryBinding="xslt2">
	<title>Schematron Tessera Portatore Di Impianto 1.0 </title>
...
<!--__________________________________________________BODY__________________________________________________________________________-->
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='74720-4']]/hl7:entry">
			...
			<assert test="count(hl7:organizer/hl7:component/hl7:observation)=0 or count(hl7:organizer/hl7:component/hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.164'])=1"
			>ERRORE-b9| Sezione Impianto del Dispositivo: entry/organizer/component/observation se Presente Deve avere un templateId con @root=2.16.840.1.113883.3.1937.777.63.10.164</assert>
		...
		<rule context="hl7:ClinicalDocument/hl7:component/hl7:structuredBody/hl7:component/hl7:section[hl7:code[@code='74720-4']]/hl7:entry/hl7:organizer/hl7:component/hl7:supply">
				...
				<assert test="count(hl7:entryRelationship/hl7:observation)=0 or count(hl7:entryRelationship/hl7:observation/hl7:templateId)=0 or count(hl7:entryRelationship/hl7:observation/hl7:templateId[@root='2.16.840.1.113883.3.1937.777.63.10.164'])=1"
				>ERRORE-b35| Sezione Impianto del Dispositivo: l'elemento supply può contenere al più un entryRelationship/observation che riporta lo stato del dispositivo conforme al 'templateId' @root='2.16.840.1.113883.3.1937.777.63.10.164' </assert>
